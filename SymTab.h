...
/*
 ...
 The symbol table is implemented using a seperate chaining hash table.
*/

//A SymEntry is the building block for linked list of (name, attribute) pairs
...
/*
 ...
 size is the current number of lists in the seperate chaining hash table
...
/* PRE: size >=0
   size is an estimate of the number of items that will be stored in the symbol table
...
//PRE: hasCurrent()==1
//change the attribute value to the current (name, attribute) pair to attr
